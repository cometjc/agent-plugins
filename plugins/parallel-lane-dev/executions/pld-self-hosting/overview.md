# PLD Self-Hosting Overview

> Goal: use PLD to continue developing PLD itself. This execution maintains a 4-thread active cap while allowing the lane pool to grow beyond 4 whenever new non-overlapping work families appear.
...
- [x] Lane 1: Scheduler Core
  - Plan: `PLD/executions/pld-self-hosting/lane-1.md`
  - Live status: see lane plan `Current Lane Status` / `PLD/scoreboard.md`

- [x] Lane 2: Scoreboard Integration
  - Plan: `PLD/executions/pld-self-hosting/lane-2.md`
  - Focus: runtime-scoreboard fail-soft work from the 2026-03-22 dev-flow improvement plan

- [x] Lane 3: Rules and Communication
  - Plan: `PLD/executions/pld-self-hosting/lane-3.md`
...
- [x] Lane 4: Regression and CLI Surface
  - Plan: `PLD/executions/pld-self-hosting/lane-4.md`
...
- [x] Lane 5: Plot-Mode Execution Migration
  - Plan: `PLD/executions/pld-self-hosting/lane-5.md`
  - Live status: see lane plan `Current Lane Status` / `PLD/scoreboard.md`

- [x] Lane 6: Self-Hosting Follow-up and Coordinator Ergonomics
  - Plan: `PLD/executions/pld-self-hosting/lane-6.md`
  - Live status: see lane plan `Current Lane Status` / `PLD/scoreboard.md`

- [x] Lane 7: PLD Meta-Optimization
  - Plan: `PLD/executions/pld-self-hosting/lane-7.md`
