...
function recordInsight(projectRoot, args) {
  if (!args.execution || !args.source || !args.kind || !args.summary) {
    throw new Error(
      'execution, source, kind, and summary are required to record an PLD execution insight',
    );
  }
