  ...
  switch (args.phase) {
    case 'implementer-assignment':
      return [
        ...
        'Required handoff format: return only one strict PLD lane handoff envelope JSON object.',
    ...
    case 'spec-review':
      return [
        ...
        'Return the result as one strict PLD lane handoff envelope JSON object with role=spec-reviewer and eventType=pass or fail.',
      ].join('\n');
    case 'quality-review':
      return [
        `Execution: ${context.execution}`,
        ...
        'Return the result as one strict PLD lane handoff envelope JSON object with role=quality-reviewer and eventType=pass or fail.',
      ].join('\n');
    ...
    default:
      throw new Error(
        'Usage: node plugins/parallel-lane-dev/scripts/pld-compose-message.cjs --phase <implementer-assignment|spec-review|quality-review|correction-loop> ...',
      );
  }
}
